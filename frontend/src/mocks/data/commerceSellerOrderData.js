...
function seedSellerOrderItems() {
  ...
  const seeds = [
    ...
    buildSellerItem({
      ...
      product_name_snapshot: "Máy khoan pin demo — sắp hết hàng",
    ...
    buildSellerItem({
      ...
      product_id: "c2000000-0000-4000-8000-000000000101",
      product_name_snapshot: "Máy khoan pin demo",
    ...
    buildSellerItem({
      ...
      product_id: "c2000000-0000-4000-8000-000000000101",
      product_name_snapshot: "Máy khoan pin — chưa tạo vận chuyển",
      item_status: "PROCESSING",
    ...
    buildSellerItem({
      ...
      product_id: "c2000000-0000-4000-8000-000000000101",
      product_name_snapshot: "Máy khoan pin — đang lấy hàng",
      item_status: "PROCESSING",
    ...
    buildSellerItem({
      ...
      product_id: "c2000000-0000-4000-8000-000000000101",
      product_name_snapshot: "Máy khoan pin — thất bại",
      item_status: "FAILED",
      order_payment_status: "FAILED",
      payment: {
