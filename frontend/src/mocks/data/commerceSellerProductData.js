...
import { MOCK_BRAND_HM_ID, MOCK_BRAND_NIKE_ID, MOCK_BRAND_ZARA_ID } from "./commerceCategoryIds";
...
function seedDemoSellerProducts() {
  ...
  const seeds = [
    buildSeedProduct({
      ...
      condition: "GOOD",
      title: "Ao khoac denim demo — sap het hang",
      description: "San pham demo ACTIVE ton kho 1.",
      weight_gram: 450,
    ...
    buildSeedProduct({
      ...
      condition: "LIKE_NEW",
      title: "Vay midi H&M demo",
      description: "San pham demo dang ban.",
      weight_gram: 280,
    ...
    buildSeedProduct({
      ...
      condition: "USED",
      title: "Hoodie nhap — chua co gia",
      description: "Draft thieu gia de test publish fail.",
      weight_gram: 420,
    ...
    buildSeedProduct({
      ...
      condition: "GOOD",
      title: "Ao thun nam demo — tam dung",
    ...
    buildSeedProduct({
      ...
      category_id: MOCK_CATEGORY_WOMEN_BOTTOMS_ID,
      condition: "GOOD",
      title: "Vay nhap — thieu anh (test publish fail)",
      description: "Draft co gia va ton kho nhung chua co media.",
      weight_gram: 260,
    ...
    buildSeedProduct({
      ...
      category_id: MOCK_CATEGORY_UNISEX_ID,
      condition: "LIKE_NEW",
      title: "Hoodie nhap — san sang dang ban",
      description: "Draft du gia, ton kho va anh.",
      weight_gram: 400,
      ...
      attributes: [
        ...
        { attribute_name: "gender", attribute_value: "UNISEX" },
      ],
    }),
  ];
