import { buildAuditActiveFilterChips } from "../utils/auditFilterHelpers.js";

export function AuditActiveFilterChips({ filters, onRemoveChip }) {
  const chips = buildAuditActiveFilterChips(filters);
