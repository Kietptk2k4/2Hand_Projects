import { buildCommentModerationActiveFilterChips } from "../utils/commentModerationFilterHelpers.js";

export function CommentModerationActiveFilterChips({ filters, onRemoveChip }) {
  const chips = buildCommentModerationActiveFilterChips(filters);
