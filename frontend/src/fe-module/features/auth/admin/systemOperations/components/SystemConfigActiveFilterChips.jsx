import { buildSystemConfigActiveFilterChips } from "../utils/systemConfigFilterHelpers.js";

export function SystemConfigActiveFilterChips({ filters, onRemoveChip }) {
  const chips = buildSystemConfigActiveFilterChips(filters);
