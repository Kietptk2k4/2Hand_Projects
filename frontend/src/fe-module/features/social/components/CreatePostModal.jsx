...
export function CreatePostModal({
  ...
  useEffect(() => {
    if (!openFilePickerOnMount) return;
        ...
        >
          <header className="flex items-center justify-between border-b border-outline-variant/50 bg-surface px-6 py-3">
            <div className="flex items-center gap-3">
              ...
              <h2 id="create-post-title" className="text-xl font-semibold text-on-surface">
                Create Post
              </h2>
            </div>
            <div className="flex items-center gap-3">
                ...
                {mediaItems.map((item, index) => (
                  <div key={item.id} className="relative shrink-0">
                    ...
                    <button
                      ...
                      className="absolute -right-1 -top-1 rounded-full bg-error p-0.5 text-on-primary"
              ...
              <div className="flex items-center justify-between border-b border-outline-variant/30 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-on-surface-variant">Posting as you</p>
                  </div>
                </div>
