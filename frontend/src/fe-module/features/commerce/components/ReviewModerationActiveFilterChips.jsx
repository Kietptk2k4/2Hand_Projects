import { buildReviewModerationActiveFilterChips } from "../utils/reviewModerationFilterHelpers.js";

export function ReviewModerationActiveFilterChips({ filters, onRemoveChip }) {
  const chips = buildReviewModerationActiveFilterChips(filters);
