# commerce-home-train-data-mode

## Purpose

Admin-configurable Commerce Home train data mode (`SEED_ONLY` | `HYBRID` | `REAL_ONLY`): file/RAM Home sim without shared-DB seed, mode-aware CF/AR/export inputs, and load-artifact upserts into Commerce consumer tables.
