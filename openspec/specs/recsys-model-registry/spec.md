# recsys-model-registry

## Purpose

Admin-visible registry of recommendation model artifact versions (active, rejected, inactive) with metrics for audit, without triggering offline export jobs from the UI.
