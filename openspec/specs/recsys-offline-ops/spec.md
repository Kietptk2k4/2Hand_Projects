...
Offline FastAPI job host for Recommended Feed ML ops (clean / train / evaluate / export) and Commerce Home offline jobs (sim, entity CF, social export, AR, load-artifact, Home LTR orchestration). Does not participate in online recommend serving.
