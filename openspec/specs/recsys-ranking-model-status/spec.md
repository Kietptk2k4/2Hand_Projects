# recsys-ranking-model-status

## Purpose

Admin/internal visibility into whether Social recommend ranking is using the loaded LightGBM (ONNX) model or the rule-based fallback, including a machine-readable reason when fallback is active.
