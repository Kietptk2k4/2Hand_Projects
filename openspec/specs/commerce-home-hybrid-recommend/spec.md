...
Commerce-owned Home recommend HTTP path: authenticated Top-50 ranking over a multi-source candidate pool with LightGBM or degraded scoring, diversity re-ranking, impression/click logging, and no Social feed HTTP on the hot path.
