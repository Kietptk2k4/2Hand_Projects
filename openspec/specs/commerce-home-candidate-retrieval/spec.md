# commerce-home-candidate-retrieval

## Purpose

Multi-source Commerce Home candidate retrieval: soft-quota union of Popular, Personal, Entity CF, and Cross-domain AR into a ≤500 `CandidateProduct` pool without semantic/ANN fill in v1.
