...
Entity-based collaborative filtering for Commerce Home: co-occurrence over leaf category and brand (not product_id pairs), offline `entity_cooccur` publishing, and online neighbor-product retrieval with request-local `cfScore`.
