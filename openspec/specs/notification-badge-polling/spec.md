...
Control unread notification badge polling on the web client: poll while the tab is visible, pause when hidden, refetch on resume, and update badge/toast when unread count increases.
