...
Commerce Home learning-to-rank: locked 15-dim `HOME_FEATURE_ORDER`, Feature Builder formulas shared by Python train and Java serve, binary engage labels, time-split dataset, LightGBM vs baseline evaluate, and gated `commerce_home_ranker` export-activate.
