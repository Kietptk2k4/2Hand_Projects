package com.twohands.social_service.common.media;

import java.net.URI;
import java.util.regex.Pattern;

/**
 * Rewrites persisted dev MinIO URLs (e.g. {@code http://localhost:9000/2hands-social-post/...})
 * to the browser-reachable origin from {@code SOCIAL_MINIO_PUBLIC_URL} at response time.
 */
