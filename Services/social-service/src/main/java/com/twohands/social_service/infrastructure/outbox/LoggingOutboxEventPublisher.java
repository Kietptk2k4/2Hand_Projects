...
public class LoggingOutboxEventPublisher implements OutboxEventPublisher {
    ...
    public LoggingOutboxEventPublisher(SocialOutboxTopicResolver topicResolver) {
    ...
    public void publish(OutboxEvent event) {
        ...
        log.info(
                "Outbox publish stub invoked. outboxEventId={}, eventType={}, topic={}, aggregateId={}, payloadBytes={}",
                event.id(),
                event.eventType(),
                topic,
                event.aggregateId(),
