...
public class SocialKafkaConsumerConfig {
    ...
    @Bean
    public String[] commerceProductRestoredEventTopics(SocialKafkaConsumerProperties properties) {
        return properties.getCommerceProductRestoredTopics().toArray(String[]::new);
    }
