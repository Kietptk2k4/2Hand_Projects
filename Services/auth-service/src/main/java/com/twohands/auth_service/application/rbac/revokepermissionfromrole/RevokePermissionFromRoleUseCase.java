...
public class RevokePermissionFromRoleUseCase {
    ...
    private static final String SUCCESS_MESSAGE = "Thu hoi permission khoi role thanh cong.";
    ...
    @Transactional
    public RevokePermissionFromRoleResult execute(RevokePermissionFromRoleCommand command) {
        ...
        role.revokePermission(permission.id(), now);
        roleRepository.save(role);

        return new RevokePermissionFromRoleResult(role.id(), permission.code());
    }
