package com.twohands.auth_service.common.media;

import java.net.URI;
import java.util.regex.Pattern;

/**
 * Rewrites persisted dev MinIO URLs (e.g. {@code http://localhost:9000/2hands-avatar/...})
 * to the browser-reachable origin from {@code *_MINIO_PUBLIC_URL} at response time.
 * Does not mutate stored DB values.
 */
