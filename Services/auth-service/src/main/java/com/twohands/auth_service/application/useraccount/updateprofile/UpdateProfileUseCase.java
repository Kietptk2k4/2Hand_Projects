...
public class UpdateProfileUseCase {
    ...
    private static final String SUCCESS_MESSAGE = "Cap nhat ho so thanh cong.";

    private final UpdateProfileValidationService validationService;
    ...
    public UpdateProfileUseCase(
            UpdateProfileValidationService validationService,
    ...
    public void execute(UpdateProfileCommand command) {
        ...
        profile.updateBasicInfo(command.displayName(), command.bio(), command.website(), command.socialLinks(), now);
        ...
        outboxEventRepository.save(outboxService.userUpdated(
                ...
                now,
                UserProjectionSyncPayload.profileOnly(profile.displayName(), null, null)
        ));
    }
