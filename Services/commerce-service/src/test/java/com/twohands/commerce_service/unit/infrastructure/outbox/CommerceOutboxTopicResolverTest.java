...
class CommerceOutboxTopicResolverTest {
    ...
    void shouldResolveAllKnownCommerceEventTypes() {
        ...
        assertThat(resolver.resolve(ShipmentReadyToShipOutboxService.EVENT_TYPE))
                .isEqualTo("commerce.shipment.ready_to_ship");
        ...
        assertThat(resolver.resolve(ProductPriceUpdatedOutboxService.EVENT_TYPE))
                .isEqualTo("commerce.product.price.updated");
        ...
        assertThat(resolver.resolve(ReviewUpdatedOutboxService.EVENT_TYPE))
                .isEqualTo("commerce.review.updated");
