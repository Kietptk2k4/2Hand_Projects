...
@Component
public class ShopRestoredOutboxService {

    public static final String EVENT_TYPE = "COMMERCE_SHOP_RESTORED";
    private static final String SOURCE = "commerce";

    private final ObjectMapper objectMapper;

    public ShopRestoredOutboxService(ObjectMapper objectMapper) {
