...
@Component
public class ProductMediaUpdatedOutboxService {

    public static final String EVENT_TYPE = "COMMERCE_PRODUCT_MEDIA_UPDATED";
    private static final String SOURCE = "commerce";

    private final ObjectMapper objectMapper;

    public ProductMediaUpdatedOutboxService(ObjectMapper objectMapper) {
    ...
    public OutboxEvent build(
        ...
        payload.put("media_count", mediaCount);
