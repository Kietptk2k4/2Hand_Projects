...
@Component
public class ShopUpdatedOutboxService {

    public static final String EVENT_TYPE = "COMMERCE_SHOP_UPDATED";
    private static final String SOURCE = "commerce";

    private final ObjectMapper objectMapper;

    public ShopUpdatedOutboxService(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    public OutboxEvent build(UUID shopId, UUID sellerId, ShopStatus status, Instant updatedAt) {
