...
@Component
public class ProductAttributesUpdatedOutboxService {

    public static final String EVENT_TYPE = "COMMERCE_PRODUCT_ATTRIBUTES_UPDATED";
    private static final String SOURCE = "commerce";

    private final ObjectMapper objectMapper;

    public ProductAttributesUpdatedOutboxService(ObjectMapper objectMapper) {
    ...
    public OutboxEvent build(
        ...
        payload.put("attribute_count", attributeCount);
        payload.put("updated_at", updatedAt.toString());

        return new OutboxEvent(
                UUID.randomUUID(),
                EVENT_TYPE,
                "product:" + productId + ":attributes:updated:" + updatedAt.toEpochMilli(),
                productId,
                SOURCE,
                serialize(payload),
