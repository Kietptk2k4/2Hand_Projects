...
public class CommerceOutboxTopicResolver {
    ...
    private static final Map<String, String> EVENT_TYPE_TO_TOPIC = Map.ofEntries(
            ...
            Map.entry("COMMERCE_ORDER_CANCEL_PENDING_REFUND", "commerce.order.cancel_pending_refund"),
            ...
            Map.entry("COMMERCE_PAYMENT_REFUNDED", "commerce.payment.refunded"),
            ...
            Map.entry("COMMERCE_SHIPMENT_READY_TO_SHIP", "commerce.shipment.ready_to_ship"),
            ...
            Map.entry("COMMERCE_SHIPMENT_CANCELLED", "commerce.shipment.cancelled"),
