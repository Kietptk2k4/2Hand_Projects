...
@Component
public class ReviewHiddenOutboxService {

    public static final String EVENT_TYPE = "COMMERCE_REVIEW_HIDDEN";
    private static final String SOURCE = "commerce";

    private final ObjectMapper objectMapper;

    public ReviewHiddenOutboxService(ObjectMapper objectMapper) {
