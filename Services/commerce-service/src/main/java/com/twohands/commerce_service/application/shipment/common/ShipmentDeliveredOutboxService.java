...
@Component
public class ShipmentDeliveredOutboxService {

    public static final String EVENT_TYPE = "COMMERCE_SHIPMENT_DELIVERED";
    private static final String SOURCE = "commerce";

    private final ObjectMapper objectMapper;

    public ShipmentDeliveredOutboxService(ObjectMapper objectMapper) {
    ...
    public OutboxEvent build(
        ...
        payload.put("delivered_at", deliveredAt.toString());
