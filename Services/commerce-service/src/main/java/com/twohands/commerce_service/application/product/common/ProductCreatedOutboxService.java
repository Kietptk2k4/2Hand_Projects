...
@Component
public class ProductCreatedOutboxService {

    public static final String EVENT_TYPE = "COMMERCE_PRODUCT_CREATED";
    private static final String SOURCE = "commerce";

    private final ObjectMapper objectMapper;

    public ProductCreatedOutboxService(ObjectMapper objectMapper) {
