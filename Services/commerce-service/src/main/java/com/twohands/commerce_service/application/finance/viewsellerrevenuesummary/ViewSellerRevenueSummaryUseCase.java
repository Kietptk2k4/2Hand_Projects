...
@Service
public class ViewSellerRevenueSummaryUseCase {
    ...
    public ViewSellerRevenueSummaryUseCase(
    ...
    public SellerRevenueSummary execute(ViewSellerRevenueSummaryCommand command) {
    ...
    public String successMessage() {
        return "Lay tong hop doanh thu seller thanh cong.";
    }
}
