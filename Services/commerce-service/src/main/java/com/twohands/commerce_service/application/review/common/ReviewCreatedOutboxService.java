...
@Component
public class ReviewCreatedOutboxService {

    public static final String EVENT_TYPE = "COMMERCE_REVIEW_CREATED";
    private static final String SOURCE = "commerce";

    private final ObjectMapper objectMapper;

    public ReviewCreatedOutboxService(ObjectMapper objectMapper) {
