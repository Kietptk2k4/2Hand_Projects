...
@Component
public class ProductArchivedOutboxService {

    public static final String EVENT_TYPE = "COMMERCE_PRODUCT_ARCHIVED";
    private static final String SOURCE = "commerce";

    private final ObjectMapper objectMapper;

    public ProductArchivedOutboxService(ObjectMapper objectMapper) {
    ...
    public OutboxEvent build(
        ...
        payload.put("archived_at", archivedAt.toString());
