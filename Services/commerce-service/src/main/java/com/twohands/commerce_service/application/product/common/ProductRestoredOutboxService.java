...
@Component
public class ProductRestoredOutboxService {

    public static final String EVENT_TYPE = "COMMERCE_PRODUCT_RESTORED";
    private static final String SOURCE = "commerce";

    private final ObjectMapper objectMapper;

    public ProductRestoredOutboxService(ObjectMapper objectMapper) {
