...
@Component
public class ShopSuspendedOutboxService {

    public static final String EVENT_TYPE = "COMMERCE_SHOP_SUSPENDED";
    private static final String SOURCE = "commerce";

    private final ObjectMapper objectMapper;

    public ShopSuspendedOutboxService(ObjectMapper objectMapper) {
    ...
    public OutboxEvent build(
        ...
        return buildEvent(shopId, sellerId, adminId, oldStatus, newStatus, reason, occurredAt, "suspended");
    }
