...
@Service
public class ViewNewestProductsUseCase {
    ...
    public ViewNewestProductsUseCase(ProductDiscoveryRepository productDiscoveryRepository, Clock clock) {
        this.productDiscoveryRepository = productDiscoveryRepository;
        this.clock = clock;
    }

    @Transactional(readOnly = true)
    public ViewProductListResult execute(ViewNewestProductsCommand command) {
    ...
    public String successMessage() {
        return "Lay danh sach hang moi ve thanh cong.";
    }
