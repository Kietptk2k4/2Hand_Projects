...
@Component
public class ShipmentCreatedNotificationPayloadParser {

    private static final String SHIPMENT_AGGREGATE_TYPE = "SHIPMENT";

    private final ObjectMapper objectMapper;

    public ShipmentCreatedNotificationPayloadParser(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    public ShipmentCreatedNotificationContext parse(NotificationEvent event) {
        ...
        if (buyerId == null) {
            throw new IllegalArgumentException("buyer_id is required for SHIPMENT_CREATED notification event.");
        }
        ...
        if (shipmentId == null || shipmentId.isBlank()) {
            throw new IllegalArgumentException("shipment_id is required for SHIPMENT_CREATED notification event.");
        }

        UUID sellerId = parseUuid(textField(payload, "seller_id"));
        ...
        return new ShipmentCreatedNotificationContext(
                buyerId,
                sellerId,
                shipmentId.trim(),
                orderId,
    ...
    private JsonNode parsePayload(String rawPayload) {
        ...
        try {
            ...
            throw new IllegalArgumentException("SHIPMENT_CREATED event payload must be valid JSON.");
        }
    }
