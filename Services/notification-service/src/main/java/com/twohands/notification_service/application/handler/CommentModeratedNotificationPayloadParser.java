...
public class CommentModeratedNotificationPayloadParser {
    ...
    public CommentModeratedNotificationContext parse(NotificationEvent event) {
        ...
        if (authorUserId == null) {
            throw new IllegalArgumentException("author_user_id is required for COMMENT_MODERATED notification event.");
        }
        ...
        if (commentId == null || commentId.isBlank()) {
            throw new IllegalArgumentException("comment_id is required for COMMENT_MODERATED notification event.");
        }
    ...
    private JsonNode parsePayload(String rawPayload) {
        ...
        try {
            ...
            throw new IllegalArgumentException("COMMENT_MODERATED event payload must be valid JSON.");
        }
    }
