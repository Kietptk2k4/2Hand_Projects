...
@Component
public class ShipmentCancelledNotificationPayloadParser {

    private static final String SHIPMENT_AGGREGATE_TYPE = "SHIPMENT";

    private final ObjectMapper objectMapper;

    public ShipmentCancelledNotificationPayloadParser(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    public ShipmentCancelledNotificationContext parse(NotificationEvent event) {
        ...
        if (buyerId == null) {
            throw new IllegalArgumentException("buyer_id is required for SHIPMENT_CANCELLED notification event.");
        }
        ...
        if (shipmentId == null || shipmentId.isBlank()) {
            throw new IllegalArgumentException("shipment_id is required for SHIPMENT_CANCELLED notification event.");
        }
        ...
        return new ShipmentCancelledNotificationContext(
                buyerId,
                shipmentId.trim(),
                orderId,
                trackingCode
    ...
    private JsonNode parsePayload(String rawPayload) {
        ...
        try {
            ...
            throw new IllegalArgumentException("SHIPMENT_CANCELLED event payload must be valid JSON.");
        }
    }
