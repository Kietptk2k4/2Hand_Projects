...
public class StoreNotificationEventUseCase {
    ...
    private final CommercePaymentFailedPayloadNormalizer commercePaymentFailedPayloadNormalizer;
    ...
    private final AdminSystemAnnouncementPayloadNormalizer adminSystemAnnouncementPayloadNormalizer;
    ...
    public StoreNotificationEventUseCase(
            ...
            CommercePaymentFailedPayloadNormalizer commercePaymentFailedPayloadNormalizer,
            ...
            AdminSystemAnnouncementPayloadNormalizer adminSystemAnnouncementPayloadNormalizer,
        ...
        this.commercePaymentFailedPayloadNormalizer = commercePaymentFailedPayloadNormalizer;
        ...
        this.adminSystemAnnouncementPayloadNormalizer = adminSystemAnnouncementPayloadNormalizer;
    ...
    public IngestNotificationEventResult execute(NotificationEventIngestCommand command) {
        ...
        normalizedPayload = commercePaymentFailedPayloadNormalizer.normalizeForStorage(
                command.eventType(),
                normalizedPayload
        );
        normalizedPayload = commerceShipmentNotificationPayloadNormalizer.normalizeForStorage(
                command.eventType(),
                normalizedPayload
        );
        normalizedPayload = commerceOrderCompletedPayloadNormalizer.normalizeForStorage(
                command.eventType(),
                normalizedPayload
        );
        normalizedPayload = adminProductModerationPayloadNormalizer.normalizeForStorage(
                command.eventType(),
                normalizedPayload
        );
        ...
        normalizedPayload = adminSystemAnnouncementPayloadNormalizer.normalizeForStorage(
                command.eventType(),
                normalizedPayload
        );
