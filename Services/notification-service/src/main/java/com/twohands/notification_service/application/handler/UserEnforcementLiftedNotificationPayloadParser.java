...
@Component
public class UserEnforcementLiftedNotificationPayloadParser {
    ...
    public UserEnforcementLiftedNotificationPayloadParser(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    public UserEnforcementLiftedNotificationContext parse(NotificationEvent event, String eventType) {
        ...
        return new UserEnforcementLiftedNotificationContext(
                targetUserId,
                enforcementId.trim(),
                REFERENCE_TYPE,
                enforcementId.trim()
    ...
    private JsonNode parsePayload(String rawPayload) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Enforcement lifted event payload must be valid JSON.");
        }
    }
