...
@Service
public class ViewUserNotificationsUseCase {
    ...
    public ViewUserNotificationsResult execute(ViewUserNotificationsCommand command) {
        ...
        PageResult<UserNotification> page = userNotificationRepository.findVisibleByUserId(
    ...
    private void validateCommand(ViewUserNotificationsCommand command) {
