...
public final class NotificationDefaultChannelPolicy {
    ...
    private static final Map<String, DefaultChannelFlags> DEFAULTS = Map.ofEntries(
            ...
            Map.entry("PAYMENT_REFUNDED", new DefaultChannelFlags(true, true, false)),
            Map.entry("ORDER_CANCELLED", new DefaultChannelFlags(true, true, false)),
            ...
            Map.entry("SHIPMENT_CANCELLED", new DefaultChannelFlags(true, true, false)),
            Map.entry("ORDER_CANCEL_PENDING_REFUND", new DefaultChannelFlags(true, true, false)),
            ...
            Map.entry("PAYOUT_REQUEST_REJECTED", new DefaultChannelFlags(true, true, false)),
