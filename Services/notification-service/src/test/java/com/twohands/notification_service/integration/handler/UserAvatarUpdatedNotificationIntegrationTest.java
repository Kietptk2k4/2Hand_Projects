...
@SpringBootTest
@ActiveProfiles("test")
class UserAvatarUpdatedNotificationIntegrationTest {
    ...
    void process_createsInAppNotificationsForFollowers() {
        ...
        UUID eventId = insertAvatarUpdatedEvent(actorId, followerA, followerB);
    ...
    private UUID insertAvatarUpdatedEvent(UUID actorId, UUID followerA, UUID followerB) {
