...
@SpringBootTest
@ActiveProfiles("test")
class ShipmentCreatedNotificationIntegrationTest {
    ...
    @Test
    void process_notifiesBuyerAndSellerInApp() {
        UUID buyerId = UUID.randomUUID();
        UUID sellerId = UUID.randomUUID();
        UUID eventId = insertShipmentCreatedEvent(buyerId, sellerId);
    ...
    void process_marksEventFailedWhenBuyerMissing() {
        UUID eventId = insertShipmentCreatedEvent(null, UUID.randomUUID());
    ...
    void process_isIdempotentForDuplicateDelivery() {
        UUID buyerId = UUID.randomUUID();
        UUID eventId = insertShipmentCreatedEvent(buyerId, null);
    ...
    private UUID insertShipmentCreatedEvent(UUID buyerId, UUID sellerId) {
