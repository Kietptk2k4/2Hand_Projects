...
const COMMERCE_BASE_URL = resolveDevServiceBaseUrl("commerce", process.env.EXPO_PUBLIC_COMMERCE_SERVICE_BASE_URL);
...
commerceApiClient.interceptors.request.use(async (config) => {
