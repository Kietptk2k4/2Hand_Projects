...
const SOCIAL_BASE_URL = resolveDevServiceBaseUrl("social", process.env.EXPO_PUBLIC_SOCIAL_SERVICE_BASE_URL);
...
socialApiClient.interceptors.request.use(async (config) => {
